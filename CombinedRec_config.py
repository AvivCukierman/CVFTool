...
from MyCompletePackage.MyCompletePackageConf import MyCompletePackageAlg
test_alg = MyCompletePackageAlg("test_alg")
test_alg.TrackExtrapolatorTool = TrackCaloExtensionTool
topSequence += test_alg
